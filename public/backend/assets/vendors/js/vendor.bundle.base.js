...
!(function (t, e) {
  ...
  function b(t, i) {
    ...
    i.isScrollbarYUsingRight
      ? i.isRtl
        ? (l.right = i.contentWidth - (i.negativeScrollAdjustment + t.scrollLeft) - i.scrollbarYRight - i.scrollbarYOuterWidth)
      ...
      (t.containerWidth = e.clientWidth),
        ...
        !t.settings.suppressScrollY && t.containerHeight + t.settings.scrollYMarginOffset < t.contentHeight
          ? ((t.scrollbarYActive = !0),
            ...
            (t.scrollbarYTop = u((e.scrollTop * (t.railYHeight - t.scrollbarYHeight)) / (t.contentHeight - t.containerHeight))))
