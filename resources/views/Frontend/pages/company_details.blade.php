...
@section('head')
    <style>
        ...
        @font-face {
            font-family: 'Space';
            src: url('{{ asset('fonts/SpaceGrotesk-Regular.ttf') }}') format('truetype');
        }
...
@section('main_content')
    ...
    <div class="content_search">
        <h2 class="py-2 fw-bold text-center {{-- text-capital --}} py-5"
        ...
        <div class="container">
            <div class="row justify-content-center align-items-start company-details mt-4">
                <div class="col-lg-6 text-center position-relative">
                    <div class="row">
                        @foreach ($contents['images'] as $item)
                            <div class="col-6 col-lg-12">
                                <img src="{{ $item }}" class="img-fluid"
                                    alt="company-details-{{ $loop->iteration }}">
                            </div>
                        @endforeach
                    </div>
                    <div class="d-none d-lg-inline malishaedu-text">
                        <span>{{ env('APP_NAME') }}</span>
                    </div>
                </div>

                <div class="col-lg-6 mt-4 mt-lg-0">
                    <p class="text-muted mb-1 details-text">Since {{ $contents['since_year'] ?? '' }}</p>
                    <span class="company-details-title">
                        {{ $contents['title'] ?? '' }}
                    </span>

                    <div class="mt-3">
                        <div class="text-muted details-text ckeditor5-rendered">
            ...
            <div>
                <div class="row justify-content-center section-space">
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-6 col-sm-6 py-4 text-center border-end" style="color: var(--text_color)">
                                <div class="mb-2">
                            ...
                            <div class="col-6 col-sm-6 py-4 text-center" style="color: var(--text_color)">
                                <div class="mb-2">
                            ...
                            <div class="col-6 col-sm-6 py-4 text-center border-end border-top"
                            ...
                            <div class="col-6 col-sm-6 py-4 text-center border-top" style="color: var(--text_color)">
                                <div class="mb-2">
            ...
            <div class="row justify-content-center section-space">
                <h2 class="text-center" style="font-family: 'Lora'; font-size:40px;">
                    {{ $contents['mediaPartners']['title'] }}
                </h2>
                ...
                <div class="row justify-content-center align-items-center mt-3">
                    ...
                    @foreach ($mediaPartnerImages as $key => $image)
                        <div class="col-6 col-lg-2 px-0 mb-2">
                            <div class="border mx-1 d-flex justify-content-center align-items-center"
                                style="padding: 1rem 4rem; border-radius:8px;">
            ...
            <div class="row justify-content-center px-4 py-5 mx-0"
                style="background-color: var(--btn_primary_color); border-radius:10px;">
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 col-lg-10">
                        <h5 style="font-size: 25px;" class="text-white">
                            <strong>Start Your Journey</strong>
                            to a Renowned Chinese University Today with MalishaEdu!
                        </h5>
                        <p class="mt-3 mt-lg-1 mb-0" style="font-size: 1rem; font-weight:600; color:rgb(230, 230, 230)">
                            Take the next step in your academic journey today with MalishaEdu!
                            Contact us now to achieve your goals in China.
                        </p>
                    </div>

                    <div class="text-center mt-4 text-lg-end col-12 col-lg-2 mt-0">
                        <a href="#contact-details" class="contact-us btn btn-lg text-white" style="font-size: 1rem">Contact
                            Us</a>
                    </div>
                </div>
            </div>
