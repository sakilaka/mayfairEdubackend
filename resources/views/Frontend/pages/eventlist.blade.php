...
@section('main_content')
    ...
    <div class="content_search">
        ...
        <div class="bg-alice-blue py-3 py-lg-0">
            <div class="container-lg p-2 p-md-5 mt-3 mt-lg-0">
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        ...
                        <div class="row justify-content-center blog_search mb-4 g-3">
                                    ...
                                    <div class="course-card rounded-3 bg-white position-relative overflow-hidden">
                                        <div class="position-relative">
                                            <a href="{{ route('frontend.event.details', $event->id) }}" class="">
                                                ...
                                                <div
                                                    class="course-card_body bg-prussian-blue  p-3 top_shadow position-relative">
                                                            ...
                                                            <tr>
                                                                <td class="ps-0">
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div
                                                                            class="course-card__hints--text fs-12 fw-bold">
                                ...
                                <button type="button" class="btn btn-lg btn-dark-cerulean" id="showMoreEvent">
                                    Load more <svg class="ms-2" xmlns="http://www.w3.org/2000/svg" width="28.56"
                                        ...
                                        <path id="right-arrow_3_" data-name="right-arrow (3)"
                                            ...
                                            transform="translate(0 -107.5)" fill="var(--btn_primary_color)"></path>
                                    </svg>
                                </button>
                            </div>
                        @endif
