...
@section('main_content')
    ...
    <div class="content_search">
        ...
        <link rel="stylesheet"
            href="{{ asset('frontend') }}/application/modules/frontend/views/themes/default/assets/css/intlTelInput.css">
        <style>
            .iti--allow-dropdown {
                width: 100%;
            }
            ...
            <div class="container-lg p-2 p-md-5">
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        ...
                        <div class="classic_header hero-header position-relative text-white" style="height:200px !important; border-radius:10px !important; overflow:hidden;">
                            ...
                            <div class="container-lg hero-header_wrap position-relative">
                                <div class="row align-items-end my-5">
                                    <div class="col-12">
                                        <h1 class="fw-semi-bold contact_txt" style="color: var(--header_text_color)">
                                            {{ @$banner->title }}</h1>
                                        <p class='m-1' style="color: var(--header_text_color)">Email :
                                            {{ @$contact_info->email1 }} </p>
                                        <p class='m-1' style="color: var(--header_text_color)"> Hotline :
                                            {{ @$contact_info->phone1 }} </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="contact_form">
                                            ...
                                            <form class="contact_form_box"
                                                action="{{ route('frontend.user.contact.store') }}" method="post"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="fullName" class="form-label"
                                                                style="color: var(--text_color)">Full Name <i
                                                                    class="text-danger"> *
                                                                </i></label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="phoneNumber" class="form-label"
                                                                style="color: var(--text_color)">Phone No.</label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="emailAddress" class="form-label"
                                                                style="color: var(--text_color)">Your Email <i
                                                                    class="text-danger"> *
                                                                </i></label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="whoAmI" class="form-label"
                                                                style="color: var(--text_color)">I am</label>
                                                            <select class="form-select form-select-lg" name="type"
                                                                aria-label="Default select example" id="whoAmI">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="organizationName" class="form-label"
                                                                style="color: var(--text_color)">Organization Name</label>
                                                            <input type="text" name="organization"
                                                                class="form-control form-control-lg" id="organizationName"
                                                                placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="prefferedDate" class="form-label"
                                                                style="color: var(--text_color)">Preffered date and
                                                                Time</label>
                                                            <input type="datetime-local" name="date"
                                                                class="form-control form-control-lg" id="prefferedDate">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
                                                            <label for="reasonForCall" class="form-label"
                                                                style="color: var(--text_color)">Reason for a call <i
                                                                    class="text-danger"> * </i></label>
                                                            <textarea class="form-control" name="details" id="reasonForCall" rows="5" placeholder="write message"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <button type="submit" class="btn btn-lg btn-dark-cerulean"
                                                    id="submit_contact">Send
                                                    Message</button>
        ...
        <script src="{{ asset('frontend') }}/application/modules/frontend/views/themes/default/assets/js/intlTelInput.js">
        </script>
        <!--gmaps Js-->
