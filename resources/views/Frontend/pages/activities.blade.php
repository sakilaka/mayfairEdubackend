...
@section('main_content')
    <div class="content_search">
        ...
        <div class="bg-alice-blue py-3 py-lg-4">
            ...
            <div class="container-lg p-2 p-md-5 pt-0">
                    ...
                    <div class="col-md-12">
                        ...
                        @php
                            ...
                            if ($page && $page['contents']) {
                                $activities = json_decode($page->contents, true);
                            }
                        @endphp
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    ...
                                    <div class="course-card rounded-3 bg-white position-relative overflow-hidden">
                                        <div class="position-relative">
                                            <!--Start Course Image-->
                                            <a href="{{ route('frontend.activity_details', ['key' => $key]) }}"
                                                class="">
                                            ...
                                            <div
                                                ...
                                                <!--Start Course Title-->
                                                <h3 class="course-card__course--title text-uppercase fs-6">
                                                    <a href="{{ route('frontend.activity_details', ['key' => $key]) }}"
                                                        class="text-decoration-none"
                                                        style="color: var(--btn_primary_color)">{{ $activity['title'] }}</a>
                                                </h3>
                                                <!--End Course Title-->
                                                <!--Start Course Hints-->
                                            ...
                                            <div class="d-flex justify-content-between align-items-stretch">
                                                <div class="flex-grow-1">
                                                    <a type="button"
                                                        ...
                                                        href="{{ route('frontend.activity_details', ['key' => $key]) }}">
