                            ...
                            <div class="position-relative">
                                ...
                                <div
                                    ...
                                    <h3 class="course-card__course--title text-uppercase fs-6 mb-1">
                                        <a href="{{ route('frontend.ebook_video_details',$event->id) }}" class="text-decoration-none" >{{ $event->title}}</a>
                                    </h3>
                                    <p class=" text-uppercase fs-6 ebook-title2">
                                        <a href="{{ route('frontend.ebook_video_details',$event->id) }}" class="text-decoration-none" >{{ $event->headline}}</a>
                                    </p>
