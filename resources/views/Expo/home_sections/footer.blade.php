                    ...
                    <div class="d-flex flex-wrap justify-content-center">
                        <div class="footer_social_item">
                            <div class="footer_social_icons_container"
                                onclick="openInNewTab('https://web.facebook.com/chinaalumni/')" style="margin-left: 0"
                                data-toggle="tooltip" title="China Alumni Association">
                        ...
                        <div class="footer_social_item">
                            <div class="footer_social_icons_container"
                                onclick="openInNewTab('https://www.instagram.com/chinaalumni/')" data-toggle="tooltip"
                                title="China Alumni">
                                <svg class="w-[40px] h-[40px] text-gray-800 dark:text-white" aria-hidden="true"
