<section class="py-5 section-background">
    <div class="container">
        ...
        @forelse ($additional_contents['co_organizerDetails'] ?? [] as $co_organizer)
            <div class="row justify-content-center mt-5">
                <div class="col-md-3">
                    <div class="d-flex flex-column justify-content-center align-items-center align-items-md-end">
                        <img src="{{ $co_organizer['logo'] ?? '' }}" alt="" class="img-fluid" width="150">
                        <div class="text-center mt-4 me-md-3">
                            <a href="{{ $co_organizer['redirect_url'] ?? '#' }}"
                ...
                <div class="col-md-8 mt-4 mt-md-0">
                    <p class="fs-5 mb-2">
                        <strong class="fw700">{{ $co_organizer['name'] ?? '' }}</strong>
                    </p>

                    <div class="ckeditor5-rendered">
                        {!! $co_organizer['details'] ?? '' !!}
                    </div>
                </div>
