    ...
    <div class="container pt-5">
        <div class="row py-3">
            ...
            <div class="col-12 col-lg-4 mt-4 mt-lg-0">
                <h4 class="footer_title">Live Support</h4>
                <p class="text">
                    Experience real-time assistance with our 24/7 Live Support. Connect instantly with our experts for
                    any inquiries or technical issues and get immediate solutions with {{ env('APP_NAME') }}.
                </p>
                ...
                <div class="d-md-flex justify-content-between align-items-start mt-4" id="contact-details">
                    <div class="mt-2">
                                ...
                                @if ($social_url->facebook)
                                    <div class="footer_social_item">
                                        <div class="footer_social_icons_container"
                                            onclick="openInNewTab('{{ $social_url->facebook }}')" style="margin-left: 0">
