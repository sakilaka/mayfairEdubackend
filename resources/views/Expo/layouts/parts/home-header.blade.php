<style>
    .home-header-container {
        background-image: url('{{ asset('frontend/images/header-banner.webp') }}');
        background-position: center;
        background-repeat: no-repeat;
        background-size: cover;
        height: 500px !important;
        border-top: 3px solid var(--primary_background);
    }
    ...
    @media (min-width:991px) {
        .home-header-container {
            ...
            border-top: 0;
            border-left: 3px solid var(--primary_background);
        }
    }
...
<header class="main-header position-relative w-100 mt-md-5 pt-1">
    <div class="row mt-md-1 position-relative">
        ...
        <div class="col-12 col-lg-6 px-0 position-relative home-header-container">
            <div class="container w-100 home-header">
                <div class="d-flex flex-column justify-content-center align-items-center text-center">
                    ...
                    <div class="home-header-search-container mx-auto">
                        <form class="hero_search_form" action="{{ route('frontend.university_course_list') }}"
                            ...
                            <div class="row justify-content-center col-12 col-lg-11 py-2 m-auto filtering_box">
                                <div class="col-11 mt-2 py-2 mt-lg-0 ps-0">
                                    <div class="d-flex">
        ...
        <div class="home-header-bottom-cards full-width-row" style="z-index: 99;">
            ...
            <div class="container row justify-content-center mx-auto">
                ...
                <div class="col-6 col-md-3 d-flex justify-content-center mb-3 mb-md-0">
                    <div class="card text-center mx-md-2 py-3 py-md-2 px-2 full-width-card"
