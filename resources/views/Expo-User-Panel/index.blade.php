                        ...
                        <div class="card-body p-2">
                            <div class="row justify-content-center justify-content-md-start">
                                {{-- @foreach ($expos as $expo)
                                    <div class="col-md-6 col-lg-4 col-xl-2 col-xxl-2" style="width: 250px !important;">
                                        <div class="course-card rounded bg-white position-relative overflow-hidden border"
                                            onclick="location.href='{{ route('frontend.expo.details', $expo->id) }}'"
                                            style="cursor: pointer">
                                            <div class="position-relative">
                                                <a href="{{ route('frontend.expo.details', $expo->id) }}"
                                                    class="d-flex justify-content-center position-relative">
                                                    <img src="{{ $expo->banner ?? '' }}"
                                                        class="img-fluid imgdiv rounded" alt=""
                                                        style="object-fit: cover; object-position: center; height: 120px; width: 100%;">
                                                ...
                                                <div
                                                    ...
                                                    <a href="{{ route('frontend.expo.details', $expo->id) }}"
                                                        ...
                                                        style="font-weight:bold; transition:0.35s;">{{ $expo->title }}</a>
                                                    <table
                                                        class="course-card__hints table table-borderless table-sm mt-2">
                                                        <tbody>
