...
<head>
    ...
    <title>{{ env('APP_NAME') }} | Edit Currency</title>
</head>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="forms-sample"
                                        action="{{ route('admin.update_currency', ['id' => $currency->id]) }}"
                                        method="POST">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input id="degree_name" type="text" name="currency_name"
                                                    class="form-control" value="{{ $currency->currency_name }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input id="degree_name" type="text" name="currency_icon"
                                                    class="form-control" value="{{ $currency->currency_icon }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input id="degree_name" type="text" name="exchange_rate"
                                                    class="form-control" value="{{ $currency->exchange_rate }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="is_default" id=""
                                                    ...
                                                    <option value="0"
                                                        {{ $currency->is_default == 0 ? 'selected' : '' }}>No
                                                    </option>
                                                    <option value="1"
                                                        {{ $currency->is_default == 1 ? 'selected' : '' }}>Yes
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
