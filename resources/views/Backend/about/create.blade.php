                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="forms-sample" action="{{ route('about-us.store') }}" method="POST"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input id="banner_title" type="text" name="banner_title"
                                                    class="form-control" placeholder="Enter Banner Title" required>
                                                @error('banner_title')
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3 d-flex justify-content-between align-items-center">
                                                <label for="banner_image1" class="col-form-label">Banner Image 1</label>
                                                <p>:</p>
                                            </div>
                                            <div class="col-sm-9">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-8 col-lg-6">
                                                        <div class="dropify-wrapper" style="border: none">
                                                            ...
                                                            <input type="file" class="dropify" name="banner_image1"
                                                                accept="image/*" id="bannerImage1">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3 d-flex justify-content-between align-items-center">
                                                <label for="banner_image2" class="col-form-label">Banner Image 2</label>
                                                <p>:</p>
                                            </div>
                                            <div class="col-sm-9">
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-8 col-lg-6">
                                                        <div class="dropify-wrapper" style="border: none">
                                                            ...
                                                            <input type="file" class="dropify" name="banner_image2"
                                                                accept="image/*" id="bannerImage2">
                                                            <button type="button" class="dropify-clear">Remove</button>
                                                            <div class="dropify-preview">
                                                                <span class="dropify-render"></span>
                                                                <div class="dropify-infos">
