...
<head>
    ...
    <title>{{ env('APP_NAME') }} | All Major</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="{{ route('admin.major.create') }}" class="btn btn-primary btn-fw">
                                    ...
                                    @foreach ($majors as $item)
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="text-center">
                                                @if ($item->status == 1)
                                                    <a href="{{ route('admin.major.status', $item->id) }}">
                                            ...
                                            <td class="text-right">
                                                <a href="{{ route('admin.major.edit', $item->id) }}"
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="{{ route('admin.major.delete') }}" method="POST" id="deleteForm">
                                        @csrf
