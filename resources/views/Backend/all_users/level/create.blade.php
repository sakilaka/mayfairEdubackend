...
<head>
    ...
    <title>{{ env('APP_NAME') }} | Add Level</title>
</head>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-12 m-auto grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form class="forms-sample" action="{{ route('admin.level.store') }}"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="number" name="eligibility_range_min" class="form-control"
                                                ...
                                                <div class="form-group">
                                                    <label class="form-control-label">Eligibility range max:
                                                        <span class="text-danger"
                                                            style="font-size: 1.25rem; line-height:0;">*</span></label>
                                                    <div class="mg-t-10 mg-sm-t-0">
                                                        <input type="number" name="eligibility_range_max" class="form-control"
