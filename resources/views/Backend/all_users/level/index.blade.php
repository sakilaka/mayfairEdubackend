                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="{{ route('admin.level.create') }}" class="btn btn-primary btn-fw">
                            ...
                            <table id="order-listing" class="table table-striped dataTable no-footer" role="grid"
                                ...
                                <thead>
                                    <tr role="row">
                                        <th>SL</th>
                                        <th>Star value</th>
                                        <th>Eligibility Range min</th>
                                        <th>Eligibility Range max</th>
                                ...
                                <tbody>
                                    @foreach ($levels as $level)
                                        <tr role="row" class="odd">
                                            ...
                                            <td>{{ $level->star_value }}</td>
                                            <td>{{ $level->eligibility_range_min }}</td>
                                            <td>{{ $level->eligibility_range_max }}</td>
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <div class="m-t-20 flex">
                                    <form action="{{ route('admin.level.delete') }}" method="POST" id="deleteForm">
                                        @csrf
                                        <input type="hidden" name="level_id" id="modal_item_id" value="">
                                    </form>
                                    <div class="mt-3">
