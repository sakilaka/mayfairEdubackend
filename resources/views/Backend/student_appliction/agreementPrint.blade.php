...
<head>
    ...
    <title>{{ env('APP_NAME') }} | Appliction-agreement-Invoice-{{ $agreement->id }}</title>
                                    ...
                                    <div class="my-2" style="height: 1450px;">
                                        ...
                                        <div class="destination-fee">
                                            ...
                                            <div>
                                                ...
                                                <div class="" style="list-style: none;">
                                                    <li>15. Party B and Party A shall perform all provisions of this Agreement; the breaching party shall
                                                        assume corresponding liabilities for breach.
                                                    </li>
                                                    <li>
                                                        16. If Party A fails to secure his admission and visa for the desired country, Party B will returned
                                                        the rest of the money he/she paid as additional cost for his/her application and other necessary
                                                        fees (see- I.3)
                                                    </li>
                                                    <li>
                                                        17. If this Agreement can not be performed due to any false documents or materials provided by
                                                        Party A or any unethical attempt, then Party B will complain to European visa/Immigration offices
                                                        about party A, so that party A could be restricted to enter any European country for a time being.
                                                    </li>
                                                    <li>
                                                        Within the period from the date of signing of this Agreement to the date when Party A has
                                                        obtained the visa, if Party A requires dissolving this Agreement due to Party A’s own cause, he/she
                                                        has to pay service charge according to the percentage of work done by Party B.
                                                    </li>
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                <li>19. If either party is prevented from performing this Agreement due to force majeure, it shall
                                                    immediately send a notice to the other party, stating the date of occurrence, nature, estimated
                                                    duration of the force majeure and the impact on the performance of this Agreement by the
                                                    impacted party, and shall provide a proof within 7 days after the date of occurrence of force
                                                    majeure.
                                                </li>
                                            </div>
                                        </div>
