...
<head>
    ...
    <title>{{ env('APP_NAME') }} | All Agreement</title>
</head>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="{{ route('admin.student_appliction_agreement_create') }}" class="btn btn-primary btn-fw">
                                ...
                                <tbody>
                                    @foreach ($agreement as $item)
                                        <tr role="row" class="odd">
                                            ...
                                            <td>{{ $item->application_id ?? 'No Application ID' }}</td>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="{{ route($action, $params) }}" class="btn text-primary delete-item">
