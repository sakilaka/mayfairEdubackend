                                                ...
                                                <td class="text-right">
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <div class="d-flex">
                                                                <a href="{{ route('admin.student_appliction_details', $item->id) }}?type=assigned"
                                                                    class="btn text-primary" data-toggle="tooltip"
                                                                    data-placement="top" data-original-title="View">
                                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                                </a>
                                                                <a href="{{ route('admin.application-form-download', $item->id) }}?type=assigned"
                                                                    class="btn text-primary" data-toggle="tooltip"
                                                                    data-placement="top"
                                                                    data-original-title="Download Application">
                                                                    <i class="fa fa-download" aria-hidden="true"></i>
                                                                </a>
                                                                <a href="{{ route('admin.application-all-document-download', $item->id) }}?type=assigned"
                                                                    class="btn text-primary" data-toggle="tooltip"
                                                                    data-placement="top"
                                                                    data-original-title="Download Application File">
                                                                    <i class="fa fa-cloud" aria-hidden="true"></i>
                                                                </a>
                                                                <a href="{{ route('admin.student_appliction_invoice', $item->id) }}?type=assigned"
                                                                    class="btn text-primary" data-toggle="tooltip"
                                                                    data-placement="top"
                                                                ...
                                                                <a href="{{ route('admin.student_appliction_edit', $item->id) }}?type=assigned"
                                                                    class="btn text-primary" data-toggle="tooltip"
