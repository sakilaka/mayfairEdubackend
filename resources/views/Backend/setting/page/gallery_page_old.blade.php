...
<head>
    ...
    <title>{{ env('APP_NAME') }} | Gallery Page</title>
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <a href="{{ route('frontend.gallery') }}" target="_blank" class="btn btn-primary btn-fw">
                        ...
                        <div class="col-10">
                            <div class="tab-content tab-content-vertical bg-white rounded">
                                <div class="tab-pane fade show active" id="program-info-tab-content" role="tabpanel"
                                    ...
                                    <form method="post" action="{{ route('admin.gallery_page_setup') }}"
