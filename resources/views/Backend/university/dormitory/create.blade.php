...
<head>
    ...
    <title>{{ env('APP_NAME') }} | Add Dormitory</title>
</head>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-9 m-auto grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form class="forms-sample" action="{{ route('admin.dormitory.store') }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="dormitory_name" type="text" name="name"
                                                        class="form-control" placeholder="Enter Dormitory Name"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="persons_in_room" type="number" name="persons_in_room"
                                                        class="form-control" placeholder="Enter Persons Per Room"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="rent" type="number" name="rent"
                                                        class="form-control" placeholder="Enter Rent Cost" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
