                                                    ...
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <div class="d-flex">
                                                                ...
                                                                <a href="{{ route('frontend.application-details', ['id' => $item->id]) }}""
                                                                    class="btn text-primary" data-toggle="tooltip"
                                                                    data-placement="top" data-original-title="View">
                                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                                </a>
                                                                <a href="{{ route('consultent.application-form-download', ['id' => $item->id]) }}"
                                                                    class="btn text-primary" data-toggle="tooltip"
                                                                    data-placement="top"
                                                                    data-original-title="Download Application">
                                                                    <i class="fa fa-download" aria-hidden="true"></i>
                                                                </a>
                                                                <a href="{{ route('frontend.consultant_application-all-document-download', $item->id) }}"
                                                                    class="btn text-primary" data-toggle="tooltip"
                                                                    data-placement="top"
                                                                ...
                                                                <a href="{{ route('consultent.student_appliction_program_edit', ['id' => $item->id]) }}"
                                                                    class="btn text-primary" data-toggle="tooltip"
    ...
    <script>
        ...
        studyFundSelect.addEventListener('change', function() {
            ...
            if (selectedValue !== '') {
                ...
                form.action = '{{ route('frontend.manage_consultant_application_filter') }}';
                form.method = 'POST';
    ...
    <script>
        $(document).ready(function() {
            $('.filter_child').on('change', function() {
                ...
                var form = $('<form>', {
                    'method': 'POST',
                    'action': '{{ route('frontend.manage_consultant_application_filter') }}'
                });
