                        ...
                        <div class="col-lg-12">
                            <div class="card px-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 d-flex justify-content-between" style="width: 92%;">
                                        <div class="">
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <p class="text">
                                                    {{ $transactionDetails->client_address ?? 'No address!' }}</p>
                                            </div>
                                            <div class="mt-2">
                                                <p class="text">Study Destination :
                                                    {{ $transactionDetails->study_in }}</p>
                                                <p class="text">File Number: {{ $transactionDetails->file_number }}
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="my-3">
                                        <p class="text" style="font-weight: bold;">Reminder :
                                            {{ $transactionDetails->reminder }}</p>
                                        <p class="text" style="font-weight: bold;">In Word:
                                            {{ $transactionDetails->reminder_in_word }}</p>
                                    </div>
